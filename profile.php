...
<body class="px-4 py-6 bg-[#F2F2F2] fade-in mb-[20px]">
    ...
    <div class="mt-4">
        <a href="points.php" class="block">
            <div class="bg-white rounded-[30px] p-6">
                <div class="flex justify-between items-center">
                <img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Travel%20and%20places/Star.png" alt="Star" class="w-12 h-12"/>                    
                    <h2 class="text-3xl font-bold text-[#171717]">Loyalty Credits</h2>
                </div>
            </div>
        </a>
    </div>
    ...
    <div class="mt-4">
        <a href="referral.php" class="block">
            <div class="bg-white rounded-[30px] p-6">
                <div class="flex justify-between items-center">
                    <h2 class="text-3xl font-bold text-[#171717]">Referral Program</h2>
                    <img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Activities/Wrapped%20Gift.png" alt="Wrapped Gift" class="w-20 h-auto" />
                </div>
            </div>
        </a>
    </div>
